    ...
    <div className="najah-shell min-h-screen">
      <header className="sticky top-0 z-20 border-b border-emerald-950/10 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-5 py-4">
          <Link href="/" className="flex items-center gap-3" aria-label="Najah.ma — الصفحة الرئيسية">
        ...
        <nav aria-label="التنقل الثانوي" className="flex gap-2 overflow-x-auto border-t border-emerald-950/5 px-5 py-2 lg:hidden">
      ...
      <footer aria-label="تذييل الموقع" className="mx-auto mt-12 flex max-w-7xl items-center justify-between border-t border-emerald-950/10 px-5 py-6 text-xs text-slate-500"><span>© 2026 Najah.ma</span><span>Réviser mieux. Progresser ensemble.</span></footer>
    </div>
  );
}
